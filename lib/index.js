...
/**
 * Метод проверки валидации аттрибутов
 * @type {Function}
 * @default null
 */
AbstractProvider.prototype._validate = null;
...
/**
 * Если установлен валидатор, то проверяет аттрбуты на соответствие
 * @param {Object} attrs - охэш аттрибутов
 * @private
 */
AbstractProvider.prototype.validate = function (attrs) {
    if (!this._validate) return true;
    var error = this._validate(attrs) || null;
