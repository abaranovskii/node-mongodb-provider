...
AbstractProvider.prototype._getCollection = function(callback) {
  ...
  this.db.collection(this.collection, {w: 1
    /*, strict: true*/ // выключаем строгую проверку из-за ошибки http://stackoverflow.com/questions/27593761/unable-fetch-collection-on-strict-true-option
  }, tick(callback));
};
