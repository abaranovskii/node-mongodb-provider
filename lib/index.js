...
AbstractProvider.prototype._getCollection = function(callback) {
  ...
  this.db.collection(this.collection, {w: 1}, tick(callback));
};
...
AbstractProvider.prototype.find = function (conditions, callback) {
  ...
  return this._getCollection(function (err, collection) {
    ...
    return collection.find(conditions).toArray(tick(function (err, result) {
      if (err) return callback(err);
...
AbstractProvider.prototype.update = function (conditions, update, callback) {
  ...
  return this._getCollection(function (err, collection) {
    ...
    return collection.update(conditions, update, {w: 1, multi: true}, tick(function (err) {
      if (err) return callback(err);
...
AbstractProvider.prototype.findAndUpdate = function(conditions, update, callback) {
  ...
  return this._getCollection(function (err, collection) {
    ...
    return collection.findAndModify(conditions, [], update, {new: true}, tick(function (err, doc) {
      if (err) return callback(err);
...
AbstractProvider.prototype.remove = function (conditions, callback) {
  ...
  return this._getCollection(function (err, collection) {
    ...
    // Удаляем документы
    return collection.remove(conditions, {w:1}, tick(callback));
  });
};
...
// Пробрасываем utils в конструктор
AbstractProvider.utils = utils;
